import"./main-f3e97f32.js";const g=[{id:1,name:"綜合水果戚風蛋糕",price:{切片:300,整塊:800,禮盒:1e3},quantity:10,category:["festival","cake"],img:"product01.png",specs:["切片","整塊","禮盒"]},{id:2,name:"藍莓乳酪蛋糕",price:{切片:300,整塊:800,禮盒:1e3},quantity:5,category:["new","cake"],img:"product02.png",specs:["切片","整塊","禮盒"]},{id:3,name:"清爽夏日鳳梨檸檬塔",price:{"6入":600,"12入":1200},quantity:10,category:["festival","new"],img:"product03.png",specs:["6入","12入"]},{id:4,name:"提拉米蘇",price:{切片:300,整塊:800,禮盒:1e3},quantity:10,category:["new","cake"],img:"product04.png",specs:["切片","整塊","禮盒"]},{id:5,name:"草莓起司蛋糕",price:{切片:300,整塊:800,禮盒:1e3},quantity:10,category:["festival","cake"],img:"product05.png",specs:["切片","整塊","禮盒"]},{id:6,name:"紅絲絨蛋糕",price:{切片:300,整塊:800,禮盒:1e3},quantity:4,category:["cake","new"],img:"product06.png",specs:["切片","整塊","禮盒"]},{id:7,name:"經典草莓馬卡龍",price:{"6入":600,"12入":1200},quantity:0,category:["festival","dessert"],img:"product07.png",specs:["6入","12入"]},{id:8,name:"經典焦糖布丁",price:{"6入":600,"12入":1200},quantity:10,category:["dessert","festival"],img:"product08.png",specs:["6入","12入"]},{id:9,name:"經典瑪徳蓮",price:{"6入":600,"12入":1200},quantity:10,category:["dessert","new"],img:"product09.png",specs:["6入","12入"]},{id:10,name:"美式軟餅乾",price:{"6入":600,"12入":1200},quantity:10,category:["dessert","new"],img:"product10.png",specs:["6入","12入"]},{id:11,name:"小柑橘杯子蛋糕",price:{"6入":600,"12入":1200},quantity:10,category:["dessert","new"],img:"product11.png",specs:["6入","12入"]},{id:12,name:"覆盆莓乳酪派",price:{切片:300,整塊:800,禮盒:1e3},quantity:10,category:["cake","new"],img:"product12.jpg",specs:["切片","整塊","禮盒"]},{id:13,name:"巧克力乳酪蛋糕",price:{切片:300,整塊:800,禮盒:1e3},quantity:10,category:["cake","new"],img:"product13.jpg",specs:["切片","整塊","禮盒"]},{id:14,name:"榛果巧克力杯子蛋糕",price:{"6入":600,"12入":1200},quantity:10,category:["dessert","new"],img:"product14.jpg",specs:["6入","12入"]}];let u="all";const m=9;let d=1;function l(n=1){d=n;const t=document.getElementById("product-list");t.innerHTML="";const s=u==="all"?g:g.filter(e=>e.category.includes(u)),a=(n-1)*m,r=a+m;s.slice(a,r).forEach(e=>{const c=document.createElement("div");c.classList.add("col-lg-4","col-md-6","col-12","mb-4");const y=e.specs.map(i=>`<option value="${e.price[i]}">${i}</option>`).join("");c.innerHTML=`
  ...
  `;const b=c.querySelector(".decrease"),f=c.querySelector(".increase"),p=c.querySelector(".quantity-input");b.addEventListener("click",()=>{let i=parseInt(p.value);i>1&&(i--,p.value=i)}),f.addEventListener("click",()=>{let i=parseInt(p.value);i<e.quantity&&(i++,p.value=i)});const h=c.querySelector(".size-select"),x=c.querySelector(".product-price");h.addEventListener("change",i=>{x.textContent=i.target.value}),c.querySelector(".add-to-cart").addEventListener("click",()=>{alert(`${e.name} ${e.price[spec]} 已加入購物車！`)}),t.appendChild(c)}),v(s.length)}window.toggleHeart=function(n){const t=n.querySelector("i");t.classList.contains("bi-heart")?(t.classList.remove("bi-heart"),t.classList.add("bi-heart-fill")):(t.classList.remove("bi-heart-fill"),t.classList.add("bi-heart"))};$(document).ready(function(){$(".product-category").on("click",function(){$(".mynaui--cupcake").removeClass("mynaui--cupcake-solid"),$(".ic--outline-cake").removeClass("ic--baseline-cake"),$(".mdi--gift-outline").removeClass("mdi--gift"),$(".codicon--sparkle").removeClass("codicon--sparkle-filled"),$(".material-symbols--star").addClass("material-symbols--star-outline"),$(this).find("span.mynaui--cupcake").length&&$(this).find("span.mynaui--cupcake").addClass("mynaui--cupcake-solid"),$(this).find("span.ic--outline-cake").length&&$(this).find("span.ic--outline-cake").addClass("ic--baseline-cake"),$(this).find("span.mdi--gift-outline").length&&$(this).find("span.mdi--gift-outline").addClass("mdi--gift"),$(this).find("span.codicon--sparkle").length&&$(this).find("span.codicon--sparkle").addClass("codicon--sparkle-filled"),$(this).find("span.material-symbols--star").length&&$(this).find("span.material-symbols--star").removeClass("material-symbols--star-outline")})});function v(n){const t=Math.ceil(n/m),s=document.getElementById("pagination");s.innerHTML="";const a=document.createElement("button");a.classList.add("btn","text-primary-900","custom-page-btn","mx-1"),a.textContent="上一頁",a.disabled=d===1,a.addEventListener("click",()=>{l(d-1)}),window.scrollTo({top:0,behavior:"smooth"}),s.appendChild(a);for(let o=1;o<=t;o++){const e=document.createElement("button");e.classList.add("btn","text-primary-900","custom-page-btn","mx-1"),e.textContent=o,o===d&&e.classList.add("active","btn-primary-600","text-grey-000"),e.addEventListener("click",()=>l(o)),window.scrollTo({top:0,behavior:"smooth"}),s.appendChild(e)}const r=document.createElement("button");r.classList.add("btn","text-primary-900","custom-page-btn","mx-1"),r.textContent="下一頁",r.disabled=d===t,r.addEventListener("click",()=>{l(d+1),window.scrollTo({top:0,behavior:"smooth"})}),s.appendChild(r)}function k(n){document.getElementById("categoryDropdown").textContent=n}document.querySelectorAll(".product-menu-mb .dropdown-item").forEach(n=>{n.addEventListener("click",function(){const t=this.textContent.trim();u=this.getAttribute("data-category"),k(t)})});function w(){const t=document.getElementById("category-list").querySelectorAll(".product-category");t.forEach(s=>{s.addEventListener("click",()=>{u=s.getAttribute("data-category"),t.forEach(a=>a.classList.remove("active")),s.classList.add("active"),l(1)})})}document.addEventListener("DOMContentLoaded",()=>{l(),w()});
