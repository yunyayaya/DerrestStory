const products = [
  { id: 1, name: "綜合水果戚風蛋糕", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 10, category: ["festival", "cake"], img: "/assets/images/img_product/product01.png", specs: ['切片', '整塊', '禮盒'] },
  { id: 2, name: "藍莓乳酪蛋糕", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 5, category: ["new", "cake"], img: "/assets/images/img_product/product02.png", specs: ['切片', '整塊', '禮盒'] },
  { id: 3, name: "清爽夏日鳳梨檸檬塔", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["festival", "new"], img: "/assets/images/img_product/product03.png", specs: ['6入', '12入'] },
  { id: 4, name: "提拉米蘇", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 10, category: ["new", "cake"], img: "/assets/images/img_product/product04.png", specs: ['切片', '整塊', '禮盒'] },
  { id: 5, name: "草莓起司蛋糕", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 10, category: ["festival", "cake"], img: "/assets/images/img_product/product05.png", specs: ['切片', '整塊', '禮盒'] },
  { id: 6, name: "紅絲絨蛋糕", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 4, category: ["cake", "new"], img: "/assets/images/img_product/product06.png", specs: ['切片', '整塊', '禮盒'] },
  { id: 7, name: "經典草莓馬卡龍", price: { "6入": 600, "12入": 1200 }, quantity: 0, category: ["festival", "dessert"], img: "/assets/images/img_product/product07.png", specs: ['6入', '12入'] },
  { id: 8, name: "經典焦糖布丁", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["dessert", "festival"], img: "/assets/images/img_product/product08.png", specs: ['6入', '12入'] },
  { id: 9, name: "經典瑪徳蓮", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["dessert", "new"], img: "/assets/images/img_product/product09.png", specs: ['6入', '12入'] },
  { id: 10, name: "美式軟餅乾", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["dessert", "new"], img: "/assets/images/img_product/product10.png", specs: ['6入', '12入'] },
  { id: 11, name: "小柑橘杯子蛋糕", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["dessert", "new"], img: "/assets/images/img_product/product11.png", specs: ['6入', '12入'] },
  { id: 12, name: "覆盆莓乳酪派", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 10, category: ["cake", "new"], img: "/assets/images/img_product/product12.jpg", specs: ['切片', '整塊', '禮盒'] },
  { id: 13, name: "巧克力乳酪蛋糕", price: { "切片": 300, "整塊": 800, "禮盒": 1000 }, quantity: 10, category: ["cake", "new"], img: "/assets/images/img_product/product13.jpg", specs: ['切片', '整塊', '禮盒'] },
  { id: 14, name: "榛果巧克力杯子蛋糕", price: { "6入": 600, "12入": 1200 }, quantity: 10, category: ["dessert", "new"], img: "/assets/images/img_product/product14.jpg", specs: ['6入', '12入'] }
];
  ...
  pageProducts.forEach((product) => {
      ...
      <div class="card border border-primary-700 h-100" style="overflow: hidden;">
          <div class="position-relative">
              <img src="${product.img}" class="card-img-top product-card-img" style="height: 240px; object-fit: cover;" alt="${product.name}">
